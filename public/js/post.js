...
window.addEventListener("load", () => {
  getPostDetails().then(async (post) => {
    ...
    const postDscription = document.querySelector("#post-description");
    ...
    postDscription.innerHTML = `${post.description}`;
    ...
    shareIcon.addEventListener("cilck", async () => {
